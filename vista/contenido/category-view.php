		...
		<div class="container-fluid">
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<form class="FormularioAjax" data-form="save" action="" method="POST" autocomplete="off" enctype="multipart/form-data">
				    	<fieldset>
				    		<legend><i class="zmdi zmdi-assignment-o"></i> &nbsp; Información del rol</legend>
				    		<div class="container-fluid">
				    			<div class="row">
